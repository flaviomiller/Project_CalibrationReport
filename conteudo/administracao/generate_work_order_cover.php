...
include_once ("../classes/conexoes/conexao.php");
    ...
    $html .= '				<thead>';
    $html .= '				  <tr>';
    $html .= '					<th class="tg-73a0" colspan="22">CUSTOMER &nbsp;&nbsp;&nbsp;'   . $row_customer['customer_name'] . "</th>";
    $html .= '					<th class="tg-73a0" colspan="9">DATE&nbsp;&nbsp;&nbsp;'  . $dataMesurement -> format('m/d/Y') . "</th>";
    $html .= '				  </tr>';
    $html .= '				</thead>';
    $html .= '				<tbody>';
    $html .= '				  <tr>';
    $html .= '					<td class="tg-73a0" colspan="11">ADDRESS &nbsp;&nbsp;&nbsp;'  . $row_customer['addres'] . "</td>";
    $html .= '					<td class="tg-73a0" colspan="11">CITY &nbsp;&nbsp;&nbsp;'  . $row_customer['city'] . "</td>";
    $html .= '					<td class="tg-73a0" colspan="9">CONTACT</td>';
    $html .= '				  </tr>';
    $html .= '				  <tr>';
    $html .= '					<td class="tg-73a0" colspan="5">STATE &nbsp;&nbsp;&nbsp;'  . $row_customer['state'] . "</td>";
    $html .= '					<td class="tg-73a0" colspan="8">ZIP &nbsp;&nbsp;&nbsp;'  . $row_customer['zip'] . "</td>";
    ...
    $html .= '				  <tr>';
    $html .= '					<td class="tg-91w8"><sup>'. $ind . "</sup>IND</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['manufacturer']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['model']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['capacity'] . " X " .  $capacidademinima . ""  . $tipodemedida . "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['sn']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['location']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">CAMPO CORNER LOAD</td>';
    ...
    $html .= '					<td class="tg-9o1m">X</td>';
    $html .= '					<td class="tg-9o1m">X</td>';
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['preweight1']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">TEST RESULT</td>';
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['preerror1']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['aftererror1']. "</td>";
    $html .= '					<td class="tg-f4iu" colspan="2">' . $row_report['afterweight1']. "</td>";
    $html .= '				  </tr>';
    $html .= '				  <tr>';
