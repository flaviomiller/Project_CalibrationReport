              ...
              <div class="col-md-12 col-sm-12  ">
                ...
                <div class="x_panel">
                   ...
                   <label class="col-form-label col-md-3 col-sm-3 ">Manufacturer </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="manufacturer" id="manufacturer" class="form-control" onchange="completarscale(this)" onkeyup="maiuscula(this)">
                            </div>
                            
                            <label class="col-form-label col-md-1 col-sm-3 ">Model </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="model" id="model" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                   ...
                   <div class="form-group row">
                            ...
                            <div class="col-md-2 col-sm-9">
                                <input type="text" name="capacity" id="capacity" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                            ...
                            <label class="col-form-label col-md-1 col-sm-3 ">S/N </label>
                            <div class="col-md-4 col-sm-9">
                    ...
                    <label class="col-form-label col-md-3 col-sm-3 ">Type </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="type" id="type" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                            <label class="col-form-label col-md-1 col-sm-3 ">Location </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="location" id="location" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                    </div>                      
                    <div class="form-group row">
                    <label class="col-form-label col-md-3 col-sm-3 ">Control# </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="control" id="control" class="form-control" onkeyup="maiuscula(this)">
                            </div>

                            <label id="testload" class="col-form-label col-md-1 col-sm-3 ">Measure</label>
                            <div class="col-md-4 col-sm-9 ">
                    ...
                    <div class="form-group">
                            <div class="col-md-9 col-sm-9  offset-md-3">
                                    ...
                                    <button type="submit" class="btn btn-success" name="btnSelectScale">Next</button>
