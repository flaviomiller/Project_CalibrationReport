...
$scale_id = filter_input(INPUT_GET, 'scale_id', FILTER_SANITIZE_NUMBER_INT);

$result_scale = "SELECT * FROM scales WHERE scale_id = '$scale_id'";
$resultado_scale = mysqli_query($conn, $result_scale);
$row_scale = mysqli_fetch_assoc($resultado_scale);
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                ...
                <div class="x_panel">
                    ...
                    <form method="POST" action="process_edit_scale.php">
                    <div class="form-group row">
                        <input type="hidden" name="scale_id" value="<?php echo $row_scale['scale_id']; ?>">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="manufacturer" value="<?php echo $row_scale['manufacturer']; ?>" class="form-control" onkeyup="maiuscula(this)">
                            </div>

                            <label class="col-form-label col-md-1 col-sm-3 ">Model </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="model" value="<?php echo $row_scale['model']; ?>" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-2 col-sm-9">
                                <input type="text" name="capacity" value="<?php echo $row_scale['capacity']; ?>" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                            ...
                            <div class="col-md col-sm-9 ">
                                    <select class="form-control" id="mincapacity" name="nmincapacity">
                                            <option value="<?php echo $row_scale['nmincapacity']; ?>"><?php echo $show_capacity; ?></option>
                            ...
                            <div class="col-md-1 col-sm-9 ">
                                    <select class="form-control" id="measure" name="nmeasure">
                                            <option value="<?php echo $row_scale['nmeasure']; ?>"><?php echo $show_nmeasure; ?></option>
                            ...
                            <div class="col-md-2 col-sm-9">
                                  <select class="form-control" id="type" name="type">
                                            <option value="<?php echo $row_scale['type']; ?>"><?php echo $show_type; ?></option>
                    ...
                    <label class="col-form-label col-md-3 col-sm-3 ">S/N </label>
                            <div class="col-md-4 col-sm-9">
                            <input type="text" name="sn" id="sn" value="<?php echo $row_scale['sn']; ?>" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                            <label class="col-form-label col-md-1 col-sm-3 ">Location </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="location" value="<?php echo $row_scale['location']; ?>" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                    </div> 
                    ...
                    <label class="col-form-label col-md-3 col-sm-3 ">Control# </label>
                            <div class="col-md-4 col-sm-9">
                                <input type="text" name="control" value="<?php echo $row_scale['control']; ?>" class="form-control" onkeyup="maiuscula(this)">
                            </div>
                            </div>
                    <div class="ln_solid"></div>
