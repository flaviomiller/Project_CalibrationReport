...
$result_calibration_report = "UPDATE `reports` SET `dtmeasurement` = '$dtmeasurement', `customer_id` = '$customer_id', `techid` = '$techid', `location` = '$location', `control` = '$control', `manufacturer` = '$manufacturer', `model` = '$model', `sn` = '$sn', `type` = '$type', `capacity` = '$capacity', `nmincapacity` = '$nmincapacity', `nmeasure` = '$nmeasure', `preweight` = '$preweight', `preerror` = '$preerror', `ndif` = '$ndif', `comment` = '$comment', `preweight1` = '$preweight1', `preweight2` = '$preweight2', `preweight3` = '$preweight3', `preweight4` = '$preweight4', `preweight5` = '$preweight5', `preerror1` = '$preerror1', `preerror2` = '$preerror2', `preerror3` = '$preerror3', `preerror4` = '$preerror4', `preerror5` = '$preerror5', `afterweight1` = '$afterweight1', `afterweight2` = '$afterweight2', `afterweight3` = '$afterweight3', `afterweight4` = '$afterweight4', `afterweight5` = '$afterweight5', `aftererror1` = '$aftererror1', `aftererror2` = '$aftererror2', `aftererror3` = '$aftererror3', `aftererror4` = '$aftererror4', `aftererror5` = '$aftererror5', `dtcalibration` = '$dtcalibration', `dtdue` = '$dtdue', `nistid` = '$nistid', `stdcert` = '$stdcert', `stdcertdate` = '$stdcertdate', `stdcertdue` = '$stdcertdue', `nistid2` = '$nistid2', `stdcert2` = '$stdcert2', `stdcertdate2` = '$stdcertdate2', `stdcertdue2` = '$stdcertdue2', `modified` = NOW() WHERE `reports`.`id` = '$id';";
...
if(mysqli_affected_rows($conn)){
    ...
    $_SESSION['msg'] = "Error updating report";
    header("Location: edit_calibration_report.php?customer_id=$id");
    echo $_SESSION['msg'];
}
...
//echo  "dtdue: $dtdue <br>";
//echo  "NIST ID#: $nistid <br>";
//echo  "Std Cert#: $stdcert <br>";
//echo  "Std Cert. Date: $stdcertdate <br>";
//echo  "Std Cert Due: $stdcertdue <br>";
//echo  "NIST ID#: $nistid2 <br>";
//echo  "Std Cert#: $stdcert2 <br>";
//echo  "Std Cert. Date: $stdcertdate2 <br>";
//echo  "Std Cert Due: $stdcertdue2 <br>";